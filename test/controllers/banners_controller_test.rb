...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { Concentration: @banner.Concentration, Firstname: @banner.Firstname, GPA: @banner.GPA, Lastname: @banner.Lastname }
    end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { Concentration: @banner.Concentration, Firstname: @banner.Firstname, GPA: @banner.GPA, Lastname: @banner.Lastname }
    assert_redirected_to banner_path(assigns(:banner))
  end
